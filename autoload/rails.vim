  ...
  if (!exists("g:rails_syntax") || g:rails_syntax)
    ...
    if &syntax == 'ruby'
      ...
      if t =~ '^model$' || t =~ '^model-arb\>'
        ...
        syn keyword rubyRailsARClassMethod attr_readonly attr_accessible attr_protected establish_connection set_inheritance_column set_locking_column set_primary_key set_sequence_name set_table_name
